...
public partial class DbLapShopContext : IdentityDbContext<ApplicationUser, ApplicationRole , string>
{
    public DbLapShopContext()
    {

    }

    public DbLapShopContext(DbContextOptions<DbLapShopContext> options) : base(options)
    {
    ...
    public virtual DbSet<TbDeliveryInfo> TbDeliveriesInfo { get; set; }
    public virtual DbSet<TbContactInfo> TbContactInfos { get; set; }
    public virtual DbSet<TbLocation> TbLocations { get; set; }
    public virtual DbSet<TbController> TbControllers { get; set; }
    ...
    public virtual DbSet<SpUserRole> SpUserRoles { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        //optionsBuilder.UseLazyLoadingProxies(); // for loading navigation properties
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbDelivery>(entity =>
        {
            ...
            entity.Property(e => e.CountOfDeliveryEvent);
        });
        ...
        modelBuilder.Entity<TbSettings>(entity =>
        {
            ...
            entity.Property(a => a.YoutubeLink).HasMaxLength(2000);
        
        });

        modelBuilder.Entity<TbReview>(entity => 
        {
            entity.HasKey(a => a.ReviewId);
            entity.HasOne(a => a.item).WithMany(a => a.Reviews).HasForeignKey(a => a.ItemId);
            entity.HasOne(a => a.Customer).WithMany(a => a.Reviews).HasForeignKey(a => a.CustomerId);
        ...
        modelBuilder.Entity<TbCountry>(entity => 
        {
            ...
            entity.Property(e => e.CostDelivery).HasColumnType("decimal(8, 2)");
        });

        modelBuilder.Entity<TbDeliveryInfo>(entity =>
        {
            entity.HasKey(a => a.DeliveryInfoId);

            entity.HasOne(d => d.TbDelivery).WithMany(p => p.TbDeliveriesInfo).HasForeignKey(d => d.DeliveryId);

            entity.HasOne(d=> d.TbCountry).WithMany(d => d.TbDeliveriesInfo).HasForeignKey(d => d.CountryId);

            entity.HasOne(a => a.TbSalesInvoice).WithOne(a => a.TbDelivryInfo).HasForeignKey<TbDeliveryInfo>(a => a.SalesInvoiceId);
        });
        
        modelBuilder.Entity<TbContactInfo>(entity =>
        {
        ...
        modelBuilder.Entity<TbAction>(entity =>
        {
            ...
            entity.HasOne(a=> a.Controller).WithMany(a=> a.LstActions).HasForeignKey(a=> a.ControllerId);
        ...
        modelBuilder.Entity<TbPage>(entity =>
        {
            ...
            entity.HasKey(a => a.PageId);
            entity.Property(a => a.ShowInHomePage).HasDefaultValue(0);
        ...
        modelBuilder.Entity<SpUserRole>(entity =>
        {
            entity.HasNoKey();
        });
